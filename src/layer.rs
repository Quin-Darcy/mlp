...
impl Layer {
    ...
    #[must_use]
    pub fn forward_pass(&self, input: &Array1<f32>) -> Result<(Array1<f32>, Array1<f32>), LayerError> {
        ...
        Ok((pre_activations, post_activations))
    }
}
...
mod tests {
    ...
    fn test_layer_forward_pass() {
        ...
        assert_eq!(
            ...
            (test_expected_pre1, test_expected_post1)
        );
        ...
        assert_eq!(
            ...
            (test_expected_pre2, test_expected_post2)
        );
        ...
        assert_eq!(
            ...
            (test_expected_pre3, test_expected_post3)
        );
    }
}
